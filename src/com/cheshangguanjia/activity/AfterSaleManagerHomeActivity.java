...
import com.cheshangguanjia.fragment.ServiceKehuguanliFragment;
import com.university.cheshangguanjia.R;

public class AfterSaleManagerHomeActivity extends FragmentActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.buttom_customer:
			...
			if (manager.findFragmentByTag("customerFragment") == null) {
				Fragment fragment = new ServiceKehuguanliFragment();
				manager.beginTransaction()
