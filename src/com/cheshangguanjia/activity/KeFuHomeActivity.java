...
import com.cheshangguanjia.fragment.KeFuHomeFragment;
import com.cheshangguanjia.fragment.ManagerMoreFragment;
import com.university.cheshangguanjia.R;

public class KeFuHomeActivity extends FragmentActivity implements OnClickListener {

	private ImageButton homePage, customerPage, morePage;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.kefu_home_activity);
		initView();
	}
	...
	private void initView() {
		...
		if (manager.findFragmentByTag("homeFragment") == null) {
			Fragment fragment = new KeFuHomeFragment();
