...
public class ShiJiaYuyueActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shijiayuyue);
		initView();
	}
	...
	public void initView(){
		...
		adapter = new GouCheXunjiaAdapter(this,"试驾预约");
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(ShiJiaYuyueActivity.this,ShiJiaYuyueDetailActivity.class);
