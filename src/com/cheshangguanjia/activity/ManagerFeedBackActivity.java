...
public class ManagerFeedBackActivity extends Activity implements IXListViewListener, OnClickListener {
	...
	private void initView() {
		...
		commentAdapter=new ManagerCommentAdapter(this,false);
		dataView.setAdapter(commentAdapter);
		
		View contentView=getLayoutInflater().inflate(R.layout.complain_selection_pop, null);
